...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first mt-2">
      <img src="../images/logo/logo1.webp" id="icon" alt="User Icon" />
    </div>

    <div class="login_dang_nhap" >
        Đăng nhập
    </div>
    ...
    <form action="login.php" method="post" >
      ...
      <input type="text" id="login" class="fadeIn second" name="user_name" placeholder="Tài khoản">
